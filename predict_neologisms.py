...
def predict_neologisms(file_path, column, n_initial_state, new_words_path, n_predictions, pred_column, pred_file):
...
def main():
    ...
    pred_file = 'Neologism predictions'
    predict_neologisms(file_path, column, n_initial_state, new_words_path, n_predictions, pred_column, pred_file)
